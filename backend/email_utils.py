...
EMAIL_ADDRESS = os.getenv("EMAIL_ADDRESS")
SENDER_NAME = "Career Platform"


def send_email_via_brevo(to_email: str, to_name: str, subject: str, html_content: str):
...
def send_verification_email(to_email: str, name: str, code: str):
    ...
    """
    send_email_via_brevo(to_email, name, "Your Career Platform verification code", html)
...
def send_bulk_import_credentials(to_email: str, name: str, temp_password: str):
    ...
    """
    send_email_via_brevo(to_email, name, "Your Career Platform account is ready", html)
...
def send_status_update_email(to_email: str, name: str, role: str, company: str, status: str):
    ...
    """
    send_email_via_brevo(to_email, name, f"Application Update: {role} at {company}", html)
...
def send_password_reset_email(to_email: str, name: str, code: str):
    ...
    """
    send_email_via_brevo(to_email, name, "Reset your Career Platform password", html)